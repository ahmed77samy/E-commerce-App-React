            ...
            <Col md={6}>
              ...
              <Row xs={1} md={2} className="m-0 r-gap-20">
                <Col className="collection-item">
                  <Link to="/shop">
                    <img src="/img/collections/8.jpg" className="img-fluid" />
                    <div>
                ...
                <Col className="collection-item">
                  <Link to="/shop">
                    <img src="/img/collections/7.jpg" className="img-fluid" />
                    <div>
                ...
                <Col className="collection-item">
                  <Link to="/shop">
                    <img src="/img/collections/11.jpg" className="img-fluid" />
                    <div>
                ...
                <Col className="collection-item">
                  <Link to="/shop">
                    <img src="/img/collections/15.jpg" className="img-fluid" />
                    <div>
