        ...
        <Container>
          <Row xs={1} md={4}>
            <Col>
              ...
              <NavDropdown.Item as={Link} to="/shop">مجموعه السباحه</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/shop">أدوات تعليميه</NavDropdown.Item>
            </Col>
            <Col>
            ...
            <Col className="collection-item">
              <Link to="/shop">
                <img src="/img/collections/14.jpg" className="img-fluid" />
              </Link>
            ...
            <Col className="collection-item">
              <Link to="/shop">
                <img src="/img/collections/6.jpg" className="img-fluid" />
              </Link>
              <div className="position-static">
