      ...
      <div className="service-content">
        <Container>
          ...
          <div className="pages-container">
            ...
            <section>
              <div className="sec-title mb-3 d-flex align-items-center">
                <BsBag className="ml-3 icon" />
                <span>مواعيد الشحن والتكاليف</span>
              </div>
            ...
            <section>
              <div className="sec-title mb-3 d-flex align-items-center">
                <TbMoneybag className="ml-3 icon" />
                <span>طرق الدفع</span>
              </div>
              <ul className="mr-4 c-gray">
            ...
            <section>
              <div className="sec-title mb-3 d-flex align-items-center">
                <AiOutlineRollback className="ml-3 icon" />
                <span>التبادلات والمرتجعات والمبالغ المستردة</span>
              </div>
