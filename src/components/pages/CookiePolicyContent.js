  ...
  return (
    <div className="content main-padding">
      <div className="cookie-content">
        <Container>
          <h3 className="text-uppercase text-center mb-5">سياسة ملفات الارتباط</h3>
          <div className="pages-container">
            ...
            <section>
              <div className="sec-title mb-3">
                <span>ما هي ملفات تعريف الارتباط وإشارات الويب والتقنيات المماثلة؟</span>
              </div>
            ...
            <section>
              <div className="sec-title mb-3">
                <span>ماذا نفعل بهذه التقنيات؟</span>
              </div>
              <ul className="mr-4 c-gray">
            ...
            <section>
              <div className="sec-title mb-3">
                <span>خياراتك عندما تأتي ملفات تعريف الارتباط وإشارات الويب والتقنيات المماثلة</span>
              </div>
